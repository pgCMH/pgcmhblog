...
The May meeting will be held at **18:00 EST on Tues, the 28<sup>th</sup>**. Once again, we will be holding the meeting in the community space at CoverMyMeds. *Please RSVP on [MeetUp](https://www.meetup.com/postgresCMH/events/bjbmcmyzhblc/) so we have an idea on the amount of food needed.*

What
----

Seal Software's very own [Arlette](https://www.linkedin.com/in/arlette-garay-28075a2/) will be presenting this month. She's going to tell us all about PostgreSQL users, role and groups. The talk will discuss best practices around their user and GRANTing permissions as well as some lessons learned around their use. Arlette will even show us a trick using roles to cut down on having to manage your `pg_hba.conf` file.
