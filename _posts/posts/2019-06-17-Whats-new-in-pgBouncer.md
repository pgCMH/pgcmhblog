...
layout: post
published: true
title: What's new in pgBouncer
modified: 2019-06-17 11:35:58
categories: articles
author: doug_hunley
tags:
  - pgcmh
...
The June meeting will be held at **18:00 EST on Tues, the 25<sup>th</sup>**. Once again, we will be holding the meeting in the community space at CoverMyMeds. *Please RSVP on [MeetUp](https://www.meetup.com/postgresCMH/events/bjbmcmyzjbhc/) so we have an idea on the amount of food needed.*

What
----

CoverMyMeds' very own [CJ](https://www.linkedin.com/in/cj-estel-21383614/) will be presenting this month. This month's meeting will be CJ telling us about what's new and improved in pgBouncer as well as how to get it up and running. Discussion will include real life examples from its use at CMM. pgBouncer is *the* lightweight connection pooler for PostgreSQL.
